...
const FloatingButtons = () => {
  ...
  const handleSendMessage = (message: string) => {
    ...
    setTimeout(() => {
      let response = "Thank you for your query! Our team will get back to you shortly. For immediate assistance, please call us at +91 77990 66011.";
  ...
  const whatsappLink = `https://wa.me/917799066011?text=${whatsappMessage}`;
