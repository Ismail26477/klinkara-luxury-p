    ...
    <section id="rooms" className="section-padding bg-background">
      <div className="container-luxury">
        ...
        >
          ...
          <h2 className="heading-luxury text-foreground mb-4">Room Types & Pricing</h2>
            ...
            >
              {room.popular && (
                <div className="absolute -top-4 left-1/2 -translate-x-1/2 z-10">
                  <span className="btn-luxury px-6 py-2 text-xs font-bold uppercase tracking-wider">Most Popular</span>
                </div>
              )}
              ...
              >
                ...
                <div className="p-8 flex-1 flex flex-col">
                  ...
                  <a href="#booking">
                    <Button variant={room.popular ? "luxury" : "luxuryOutline"} className="w-full" size="lg">
                      Book Now
                    </Button>
                  </a>
                </div>
